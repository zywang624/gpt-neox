...
class GPTNeoXConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        lskv_use_decoupled_rope=False,
        lskv_rotary_dim=None,
        lskv_absorbed_inference=False,
        **kwargs,
    ):
        ...
        self.lskv_use_decoupled_rope = lskv_use_decoupled_rope
        self.lskv_rotary_dim = lskv_rotary_dim
        # inference-time absorbed (matrix-fused) distant path; equivalent to the
        # non-fused path, toggled at eval to cross-check. NOT a trained param.
        self.lskv_absorbed_inference = lskv_absorbed_inference
