...
import torch
from lskv_modeling import GPTNeoXConfig, GPTNeoXForCausalLM
...
def convert(input_checkpoint_path, loaded_config, output_checkpoint_path):
    ...
    for layer_i in tqdm(range(get_key(loaded_config, "num-layers"))):
        ...
        for key in [
            "attention.down_up_proj.0.weight", "attention.down_up_proj.0.bias",
            "attention.down_up_proj.2.weight", "attention.down_up_proj.2.bias",
        ]:
